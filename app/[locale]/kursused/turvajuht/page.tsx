...
import { buildProgrammGrupid, programmTurvajuhtGrupidStructure } from '../programmSisu'
...
export default function TurvajuhtTase5() {
  ...
  const programItems = t.raw('programLeadItems') as string[]
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-[48rem] mx-auto page-gutter-x py-16">
        ...
        <div className="mb-9 text-center md:mb-12">
          <div className="flex justify-center mb-4" aria-hidden>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="size-[100px] text-course-lead-600"
            >
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">{t('securityLead.title')}</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {t('securityLead.subtitle')}
          </p>
        </div>
        ...
        <div className="mb-9 max-sm:px-0 max-sm:py-0 rounded-xl bg-white border border-gray-200 px-[12px] py-6 shadow-sm md:mb-12">
          <div className="flex items-stretch max-sm:flex-col">
            ...
            <div className="flex max-sm:grid max-sm:grid-cols-[1fr_auto_1fr] flex-1 flex-col items-center justify-center text-center max-sm:items-center max-sm:gap-x-3 max-sm:px-4 max-sm:py-3.5">
              ...
              >
                <span
                  className={`w-full inline-flex items-center justify-center gap-[0.2rem] py-1.5 pl-3 pr-4 rounded-lg text-sm font-semibold ${badgeSpanMobileClass} max-sm:shrink-0 bg-course-lead-50 text-course-lead-800`}
                >
              ...
              <div className="text-3xl text-course-lead-600 font-number mb-3 max-sm:mb-0 sm:order-1 max-sm:text-left max-sm:justify-self-start max-sm:self-center tabular-nums">2480€</div>
            </div>
            ...
            <div className="flex max-sm:grid max-sm:grid-cols-[1fr_auto_1fr] flex-1 flex-col items-center justify-center text-center max-sm:items-center max-sm:gap-x-3 max-sm:px-4 max-sm:py-3.5">
              ...
              >
                ...
                >
                  ...
                  <span className="hidden sm:inline">{t('securityLead.durationBadge')}</span>
                </span>
              </div>
              <div className="text-3xl text-course-lead-600 font-number mb-3 max-sm:mb-0 sm:order-1 max-sm:text-left max-sm:justify-self-start max-sm:self-center tabular-nums">106h</div>
            </div>
            <div className="w-px bg-gray-200 flex-shrink-0 self-stretch max-sm:self-center max-sm:w-[80%] max-sm:h-px max-sm:shrink-0" aria-hidden />
            {/* Tase */}
            <div className="flex max-sm:grid max-sm:grid-cols-[1fr_auto_1fr] flex-1 flex-col items-center justify-center text-center max-sm:items-center max-sm:gap-x-3 max-sm:px-4 max-sm:py-3.5">
              ...
              <div className="text-3xl text-course-lead-600 font-number mb-3 max-sm:mb-0 sm:order-1 max-sm:text-left max-sm:justify-self-start max-sm:self-center tabular-nums">5</div>
            </div>
          </div>
        </div>
        ...
        <section className="mb-9 md:mb-12">
          ...
          <ProgrammTeemad
            grupid={buildProgrammGrupid(programItems, programmTurvajuhtGrupidStructure)}
            variant="lead"
          />
        </section>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <span className="ml-2 inline-block px-2 py-0.5 bg-course-lead-50 text-course-lead-800 rounded text-xs font-semibold">18+</span>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-6 h-6 text-course-lead-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="divide-y divide-gray-200">
            {[
              ...
              <article key={item.title} className="flex items-center py-6 first:pt-0 last:pb-0" style={{ gap: '1.5rem' }}>
                <div className="flex-shrink-0 w-[3rem] h-[3rem] text-course-lead-600">
                  {item.icon}
                </div>
        ...
        <section className="mb-9 md:mb-12">
          ...
          <a
            ...
            className="flex min-w-0 items-center gap-3 px-5 py-3 rounded-xl border border-gray-200 bg-white text-course-lead-700 font-semibold hover:bg-course-lead-50 transition-colors shadow-sm"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6 shrink-0 text-course-lead-600">
        ...
        <div className="bg-gradient-to-r from-course-lead-600 to-course-lead-800 rounded-2xl shadow-lg p-8 md:p-10 text-center text-white max-w-3xl mx-auto">
          <h3 className="text-2xl md:text-3xl font-bold mb-2">{t('securityLead.title')}</h3>
          <p className="text-course-lead-100 mb-6 text-sm md:text-base">
            <span className="font-number">2480€</span> • <span className="font-number">106h</span> • {t('level')}{' '}
            <span className="font-number">5</span>
          </p>
          <p className="mb-6 text-course-lead-100">
            {t('ctaText')}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href={`/registreerimine?type=course&name=${encodeURIComponent('Turvajuht, tase 5')}&level=Tase 5&price=2480€&duration=106h`}
              className="btn-press px-6 py-3 bg-white text-course-lead-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors border-2 border-white cursor-pointer"
            >
              {t('registerCourse')}
            </Link>
          </div>
