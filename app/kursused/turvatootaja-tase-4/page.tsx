      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Kogenud turvatöötajatele mõeldud täiendkoolitus
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
            <div className="text-3xl font-bold text-primary-600 mb-2">550€</div>
            <div className="text-sm text-gray-600">Hind</div>
          </div>
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
            <div className="text-3xl font-bold text-primary-600 mb-2">60h</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 md:p-12 mb-8">
          ...
          <p className="text-gray-700 mb-6 leading-relaxed text-lg">
            Turvatöötaja tase 4 koolitus on mõeldud kogenud turvatöötajatele, 
            kes soovivad täiendada oma teadmisi ja oskusi.
          </p>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
            ...
            <p className="text-gray-700">
              Koolitusele registreerumiseks on vaja omada valvetöötaja tase 3 kvalifikatsiooni.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-xl shadow-lg p-8 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/meiest/paring?type=course&name=Turvatöötaja&level=Tase 4&price=550€&duration=60h"
